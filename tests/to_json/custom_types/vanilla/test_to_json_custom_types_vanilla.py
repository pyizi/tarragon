...
from tests.model.vanilla.foo.model import Type4
...
def model_representation():
    return ModelRepresentation(ModelType.VANILLA)


def test_to_json_dict_of_vanilla(model_representation):
    uid = 7
...
def test_to_json_list_of_vanilla(model_representation):
    type5_object = Type5(None, None, None, None, None)
    type4_object = Type4(None, None, None, type5_object, None)
    type5_object.type4 = type4_object
...
def test_to_json_tuple_of_vanilla(model_representation):
    type5_object = Type5(None, None, None, None, None)
    type4_object = Type4(None, None, None, type5_object, None)
    type5_object.type4 = type4_object
    hook = Hook()
...
def test_to_json_vanilla(model_representation):
    y = "1"
